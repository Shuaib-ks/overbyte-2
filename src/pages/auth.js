...
export function signup() {
  return shellAuth(`<div class="auth-panel">
    ...
    <form class="auth-form" id="signup-form">
      ...
      <div class="field"><label for="password">Password</label><input class="input" id="password" name="password" type="password" autocomplete="new-password" placeholder="At least 10 characters" minlength="10" maxlength="128" required/></div>
      ${errorBox()}
