...
function businessPanel() {
  ...
  return `<div class="col gap-20">
    <div class="card card-pad"><div class="card-title">Business profile</div><p class="t-xs muted" style="margin-top:4px">Your business name and approximate pickup location appear on your listings. Contact email is shared only with businesses you order from or sell to.</p>
